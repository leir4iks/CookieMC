...
package io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.extensions.compactnotation;

import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct;
...
public class CompactConstructor extends io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Constructor {
    ...
    protected Object constructCompactFormat(ScalarNode node, io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.extensions.compactnotation.CompactData data) {
        try {
    ...
    protected Object createInstance(ScalarNode node, io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.extensions.compactnotation.CompactData data) throws Exception {
    ...
    public io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.extensions.compactnotation.CompactData getCompactData(String scalar) {
        if (!scalar.endsWith(")")) {
            return null;
            ...
            if (m.matches()) {
                ...
                io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.extensions.compactnotation.CompactData data = new io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.extensions.compactnotation.CompactData(tag);
                if (content.length() == 0) {
                    return data;
                } else {
