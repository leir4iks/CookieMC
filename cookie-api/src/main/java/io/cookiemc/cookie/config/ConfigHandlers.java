...
import io.cookiemc.cookie.config.annotation.Pattern;
import io.cookiemc.cookie.config.annotation.RegisteredHandler;
import io.cookiemc.cookie.config.annotation.numeric.NegativeNumericValue;
import io.cookiemc.cookie.config.annotation.numeric.NonNegativeNumericValue;
import io.cookiemc.cookie.config.annotation.numeric.NonPositiveNumericValue;
