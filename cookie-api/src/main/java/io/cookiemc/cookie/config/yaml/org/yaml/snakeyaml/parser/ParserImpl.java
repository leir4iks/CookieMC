...
package io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.parser;
...
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.DumperOptions.Version;
...
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.AliasEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.DocumentEndEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.DocumentStartEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.Event;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.ImplicitTuple;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.MappingEndEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.MappingStartEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.ScalarEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.SequenceEndEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.SequenceStartEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.StreamEndEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.events.StreamStartEvent;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.reader.StreamReader;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.scanner.Scanner;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.scanner.ScannerImpl;
...
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.tokens.Token.ID;
