...
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.LoaderOptions;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.TypeDescription;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.error.YAMLException;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.introspector.Property;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.MappingNode;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Node;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.NodeId;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.NodeTuple;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.ScalarNode;
import io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.SequenceNode;
...
public class Constructor extends SafeConstructor {
    private static final Logger LOGGER = LogManager.getLogger("YamlConstructor"); // cookie
    ...
    protected class ConstructMapping implements io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct {
        ...
        protected Object constructJavaBean2ndStep(MappingNode node, Object object) {
            ...
            for (NodeTuple tuple : node.getValue()) {
                ...
                try {
                    ...
                    // cookie start - allow removal of config options without killing the server
                    Property property;
                    try {
    ...
    protected class ConstructYamlObject implements io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct {
        protected ConstructYamlObject() {
        }

        private io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct getConstructor(Node node) {
            Class<?> cl = Constructor.this.getClassForNode(node);
            node.setType(cl);
            io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct constructor = Constructor.this.yamlClassConstructors.get(node.getNodeId());
            return constructor;
        }
    ...
    protected class ConstructScalar extends AbstractConstruct {
        ...
        private Object constructStandardJavaInstance(Class type, ScalarNode node) {
            ...
            if (type == String.class) {
                io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct stringConstructor = Constructor.this.yamlConstructors.get(Tag.STR);
                result = stringConstructor.construct(node);
            } else if (type != Boolean.class && type != Boolean.TYPE) {
                if (type != Character.class && type != Character.TYPE) {
                    if (Date.class.isAssignableFrom(type)) {
                        io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct dateConstructor = Constructor.this.yamlConstructors.get(Tag.TIMESTAMP);
                        ...
                        if (type != Byte.class && type != Short.class && type != Integer.class && type != Long.class && type != BigInteger.class && type != Byte.TYPE && type != Short.TYPE && type != Integer.TYPE && type != Long.TYPE) {
                            if (Enum.class.isAssignableFrom(type)) {
                                ...
                                try {
                                    // cookie start - allow overriding parse rules
                                    try {
                            ...
                            io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct intConstructor = Constructor.this.yamlConstructors.get(Tag.INT);
                        ...
                        io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct doubleConstructor = Constructor.this.yamlConstructors.get(Tag.FLOAT);
                    ...
                    io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct charConstructor = Constructor.this.yamlConstructors.get(Tag.STR);
                ...
                io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.constructor.Construct boolConstructor = Constructor.this.yamlConstructors.get(Tag.BOOL);
