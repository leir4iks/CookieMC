...
public class ScalarNode extends Node {
    ...
    public ScalarNode(io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag tag, String value, Mark startMark, Mark endMark, ScalarStyle style) {
        this(tag, true, value, startMark, endMark, style);
    }

    public ScalarNode(io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag tag, boolean resolved, String value, Mark startMark, Mark endMark, ScalarStyle style) {
     ...
     */
    @Deprecated
    public ScalarNode(io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag tag, String value, Mark startMark, Mark endMark, Character style) {
