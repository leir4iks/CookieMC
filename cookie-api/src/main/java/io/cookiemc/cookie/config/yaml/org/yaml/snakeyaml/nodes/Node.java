...
public abstract class Node {
    ...
    private io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag tag;
    private Class<? extends Object> type;
    private boolean twoStepsConstruction;
    private String anchor;

    public Node(io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag tag, Mark startMark, Mark endMark) {
        this.setTag(tag);
    ...
    public io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag getTag() {
        return this.tag;
    }

    public void setTag(io.cookiemc.cookie.config.yaml.org.yaml.snakeyaml.nodes.Tag tag) {
        if (tag == null) {
