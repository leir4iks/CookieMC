...
/**
 * An interface into cookie' tick scheduler
 */
public interface MultithreadedTickScheduler {
     ...
     *       }
     * }, NamespacedKey.fromString("cookie:example"));
     * }</pre>
     *
     * @param tick       the tick
     ...
     * <br>
     * The identifier for tick loops is not forced to be unique. Within cookie internals, this is always unique, with plugins, it is unpredictable.
     *
