...
import io.cookiemc.cookie.RollingAverage;
import io.cookiemc.cookie.TickTimes;
...
public interface WrappedTickLoop {
     ...
     * If this is an instanceof a {@link io.cookiemc.cookie.LevelAccess}, then
     ...
     * <pre>{@code
     * boolean isEmptySleepPerWorld = io.cookiemc.cookie.config.impl.ConfigAccess.get().<Boolean>getField("emptySleepPerWorlds");
     * }</pre>
     *
     ...
     * Each tick-loop with cookie contains debug information
     * specifically tailored to its environment that assists
     * with development with and for cookie. This is provided
