...
public class AsyncPathProcessor {
    ...
    private static final String THREAD_PREFIX = "cookie Async Pathfinding";
    ...
    private static class RejectedTaskHandler implements RejectedExecutionHandler {
        ...
        public void rejectedExecution(Runnable rejectedTask, @NotNull ThreadPoolExecutor executor) {
            ...
            if (System.currentTimeMillis() - lastWarnMillis > 30000L) {
                LOGGER.warn("Async pathfinding processor is busy! Pathfinding tasks will be treated as policy defined in config. Increasing max-threads in cookie config may help.");
