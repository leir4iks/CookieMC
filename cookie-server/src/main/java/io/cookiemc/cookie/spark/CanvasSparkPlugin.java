package io.cookiemc.cookie.spark;
...
public class cookieSparkPlugin implements PaperSparkModule, SparkPlugin {
    ...
    public cookieSparkPlugin(Server server, Logger logger, PaperScheduler scheduler, PaperClassLookup classLookup) {
        this.server = server;
        this.logger = logger;
    ...
    public static @NotNull PaperSparkModule create(Compatibility compatibility, Server server, Logger logger, PaperScheduler scheduler, PaperClassLookup classLookup) {
        return new cookieSparkPlugin(server, logger, scheduler, classLookup);
    }
    ...
    public ServerConfigProvider createServerConfigProvider() {
        return new cookieServerConfigProvider();
    }
