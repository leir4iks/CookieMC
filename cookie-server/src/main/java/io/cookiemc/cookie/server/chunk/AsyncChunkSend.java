package io.cookiemc.cookie.server.chunk;
...
public class AsyncChunkSend {
    ...
    public static final ExecutorService POOL = new ThreadPoolExecutor(
        ...
        new ThreadFactoryBuilder()
            ...
            .setNameFormat("cookie Async Chunk Send Thread")
            .setUncaughtExceptionHandler(Util::onThreadException)
            .setThreadFactory(AsyncChunkSendThread::new)
            .build(),
        new ThreadPoolExecutor.CallerRunsPolicy()
    );
    public static final Logger LOGGER = LogManager.getLogger("cookie Async Chunk Send");
