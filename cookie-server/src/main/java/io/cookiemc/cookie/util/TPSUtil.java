...
public class TPSUtil {
    ...
    public static double rawTT20(double ticks, @Nullable ServerLevel level) {
        return ticks == 0 ? 0 : ticks * (level == null ? MinecraftServer.getServer().tpsCalculator.getMostAccurateTPS() : ServerRegions.getTickData(level).tpsCalculator.getMostAccurateTPS()) / MAX_TPS; // cookie - Threaded Regions
    }
}
