...
public class cookieBootstrap {
    public static final Instant BOOT_TIME = Instant.now();
    public static ComponentLogger LOGGER = ComponentLogger.logger("cookie");
    ...
    public static OptionSet bootstrap(String[] args) {
        ...
        if ((options == null) || (options.has("?"))) {
            try {
                ...
                Logger.getLogger(cookieBootstrap.class.getName()).log(Level.SEVERE, null, ex);
            }
