package io.cookiemc.cookie.command.debug;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.tree.LiteralCommandNode;
import io.cookiemc.cookie.command.CommandInstance;
import io.cookiemc.cookie.region.ChunkRegion;
...
import static io.cookiemc.cookie.server.ThreadedServer.LOGGER;
...
public class SenderInfoCommand implements CommandInstance {
    ...
    public LiteralCommandNode<CommandSourceStack> register(@NotNull CommandDispatcher<CommandSourceStack> dispatcher) {
        return dispatcher.register(
            literal("senderinfo").requires(commandSourceStack -> commandSourceStack.hasPermission(3, "cookie.debug.command.senderinfo"))
                .executes(context -> {
