...
public abstract class ExecutorManager extends PrioritisedThreadPool {
    ...
    public final DynamicPriorityQueue<Task> globalWorkQueue; // cookie - private -> protected
    protected final ConcurrentMap<LockToken, FreeableTaskList> lockListeners = new ConcurrentHashMap<>(); // cookie - private -> protected
    protected final WorkerThread[] workerThreads; // cookie - private -> protected
    ...
    public void wakeup() { // cookie - private -> public
    ...
    protected static class FreeableTaskList extends ReferenceArrayList<Task> { // cookie - private -> protected
